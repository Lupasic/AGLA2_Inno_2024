...
\begin{frame}[t]{Complex numbers}
    ...
    \begin{itemize}
        ...
        \item \textit{Multiplication} -- $(x_1 + iy_1)(x_2 + iy_2) = (x_1x_2 - y_1y_2) + i(x_1x_2 + y_1y_2)$
        \item \textit{Division} -- $\dfrac{(x_1 + iy_1)}{(x_2 + iy_2)} = \dfrac{(x_1x_2 + y_1y_2)}{x_2^2 + y_2^2} + i\dfrac{(y_1y_2 - x_1x_2)}{x_2^2 + y_2^2} $
    \end{itemize}
\end{frame}
...
\begin{frame}[t]{Complex numbers}
    ...
    \begin{columns}[T,onlytextwidth]
        \begin{column}{0.7\textwidth}
            ...
            \textbf{Operations}
            \begin{itemize}
                \item  \textit{Summarization and Substraction} -- ${\overline {z\pm w}}={\overline {z}}\pm {\overline {w}}$
                \item \textit{Multiplication} -- ${\overline {z\cdot w}}={\overline {z}}\cdot {\overline {w}}$
                \item \textit{Division} -- ${\overline {z/w}}={\overline {z}}/{\overline {w}}$
            \end{itemize}
...
\begin{frame}[t]{Task 1}
    ...
    \begin{multicols}{2}
        ...
        \end{enumerate}
    \end{multicols}
    \only<2-5>{\alert{\Large Answer} \\ \todo[inline]{Fix Using matlab}}
    \only<2>{\href{https://www.kontrolnaya-rabota.ru/s/equal-one/any-uravnenie/expr/d2ceda2e3e26d3d04083ac82a3b37db3/}{Solution (rus)}}
    \only<3>{}
    \only<4>{}
    \only<5>{}
