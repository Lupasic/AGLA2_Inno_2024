...
\subtitle{Systems of linear differential equations \\ \  \\ \ 
         } %% title page.
...
\begin{frame}[c]{How I spent last weekend}
    ...
    %         \centering\includegraphics[height=5cm,width=1\textwidth,keepaspectratio]{flex_1.JPG}
    %     \end{subfigure}
    %     \hfill
    %     \begin{subfigure}{0.49\textwidth}
    %         \centering\includegraphics[height=5cm,width=1\textwidth,keepaspectratio]{flex_2.JPG}
    %     \end{subfigure}
    %     \caption*{\Large RAGE and VEGs clubs collaboration event}
    % \end{figure}
\end{frame}
